...
const appState = {
  doctors: [
    ...
    {
      id: 8,
      name: "Dr. Ishan Sharma",
      specialty: "Cardiology",
      rating: 4.8,
      reviews: 245,
      location: "hawabangla Medical Center",
      availability: "Mon-Fri 9AM-5PM",
      fee: "$80",
     ...
     {
      id: 9,
      name: "Dr. Devanginee Sen",
      specialty: "Neurology",
      rating: 4.9,
      reviews: 156,
      location: "Neurological Institute at gandhi nagar",
      availability: "Wed-Fri 1PM-7PM",
      fee: "$110",
  ...
  feedback: [
    ...
    { id: 2, patient: "Rohit Choubey", rating: 4.5, comment: "Absolutely brilliant!" },
  ],
  currentDoctor: null,
  isLoggedIn: false,
  currentUser: null,
